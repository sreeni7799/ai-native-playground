...
setup(
    ...
    description="A collection of AI-powered applications including weather API, news analyzer, todo app, university recommendations, and scholarship finder",
    ...
    entry_points={
        "console_scripts": [
            ...
            "scholarship-recommend=ai_native_playground.scholarships.recommend_cli:main",
            "scholarship-chat=ai_native_playground.scholarships.chat_cli:main",
        ],
    },
